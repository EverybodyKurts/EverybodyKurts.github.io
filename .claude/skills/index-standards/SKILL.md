...
description: Rebuild and maintain the standards index file (index.yml). Use after manually creating or deleting standards files, or if inject-standards suggestions seem out of sync.
