...
description: Inject relevant coding standards into the current context. Use when implementing code, creating skills, or shaping plans that should follow project conventions.
argument-hint: "[folder/standard ...]"
---
