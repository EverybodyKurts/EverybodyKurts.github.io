---
name: shape-spec
description: Gather context and structure planning for significant work. Creates spec documentation with standards, references, and implementation tasks. Must be run in plan mode.
