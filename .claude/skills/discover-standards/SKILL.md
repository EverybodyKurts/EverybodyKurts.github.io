...
description: Extract tribal knowledge from your codebase into concise, documented standards. Use when you want to identify and document coding patterns, conventions, or practices that aren't formally written down.
